...
const Footer = (props: Props) => {
  return (
    <footer className="flex flex-col relative text-center md:text-left md:flex-row max-w-7xl xl:md:px-10 px-5 justify-evenly mx-auto items-center h-screen">
      <div className="w-full h-full relative top-0 flex flex-col justify-center items-center">
      ...
      <Link className="pt-5 absolute bottom-24 xl:pb-16 pb-24" href="#hero">
        <button className="heroButton">Back To Top ↑</button>
      </Link>
      <div className="pt-5 absolute bottom-24">
        <Link href="#about">
